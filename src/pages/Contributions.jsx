...
function Contributions() {
    ...
    const { items: artistsNames, isLoading: loadingArtists } = useData('artists?page=2&limit=100');
    const { items: artworksItems, isLoading: loadingArts} = useData('artworks?page=2&limit=100')
